...
//nglPath CachePath = "/data/cache/old_cache";
int64 CacheSize = 1024L * 1024L * 1024L * 1000L; // 1 Tb
//int64 CacheSize = 1024L * 1024L * 1024L * 100L; // 100 Gb
//int64 CacheSize = 1024L * 1024L * 10L; // 10Mb
