...
int main( int argc, char* argv[] )
{
  ...
  /* Print Text */
	...
	{
		fprintf( textout, "\n" );
		fprintf( textout, "BladeEnc 0.85    (c) Tord Jansson       Homepage: http://www.bladeenc.cjb.net\n" );
		fprintf( textout, "===============================================================================\n" );
...
#endif
				fprintf( textout, "  -refresh=[rate]      Refresh rate for progress indicator. 1=fastest, 2=def.\n" );
        fprintf( textout, "\n" );
